function loadLevel1() {
    ...
    if (currentTarget === "LR 5") {
        ...
        marker1Content = `
            <a-text value="TO LR 5 (L1)" position="0 1.5 0" align="center" color="#00FFFF"></a-text>
            <a-entity geometry="primitive: cone" material="color: lime" rotation="-90 0 0"></a-entity>`;
            
        // At LR 5 (Marker 2), Arrival Effect
        marker2Content = `
            <a-text value="ARRIVED AT LR 5" position="0 1.8 0" align="center" color="#00FF00"></a-text>
    ...
    if (currentTarget === "Lobby") {
        marker1Content = `
            <a-text value="YOU ARE AT LOBBY" position="0 1.8 0" align="center" color="#00FF00"></a-text>
            <a-entity geometry="primitive: sphere" material="color: gold" animation="property: scale; to: 1.2 1.2 1.2; dir: alternate; loop: true"></a-entity>`;
    }
